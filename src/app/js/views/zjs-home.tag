    ...
    <div>
        ...
        <div class="section white">
            <div class="row container">
                ...
                <p class="grey-text text-darken-3 lighten-3">Parallax es un efecto en donde el contenido de fondo o en este caso una imagen, se mueve a una velocidad diferente al contenido en primer plano mientras se desplaza verticalmente por la página.</p>
            </div>
            <div class="row container">
                ...
                <div class="promo__wrap">
                    <div class="site__centered black">
                        ...
                        <div class="promo__content black">
                            ...
                            <p class="white-text">2100 Vector Icons for iOS, Android, Websites &amp; Apps</p>
                        </div>
                        <!-- /promo__content -->
                        ...
                        <!-- promo__parenthesis -->
                        <div class="promo__parenthesis visible white-text">Crafted by Adoric &amp; Hacking UI</div>
                        <!-- /promo__parenthesis -->

                        <!-- btn -->
                        <a href="#sharpest-icons" class="btn btn_1 anchor blue">
                            <span>Show Me More</span>
                        </a>
                        <!-- /btn -->
